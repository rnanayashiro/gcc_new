...
<main id="main" class="contents">
    <div class="main-contents">
        <h1 class="main-title-eng">Privacy Policy</h1>
        ...
        <div class="contents-box">
            ...
            <div class="">
                <span class="font-point_bblk">個人情報の取り組み</span><br>
                株式会社グローバル・コーポレート・コンサルティング、税理士法人GCC、GCC SERVICES（THAILAND）CO.,LTD、（以下、各社にて「当社」といいます。）は、個人情報の保護に関する法律（以下「個人情報保護法」または「法」といいます。）における個人報取扱事業者として、
                個人情報保護の必要性及び重要性を認識し、個人情報に関して適用される法規律、指針その他の規範を順守し個人情報の保護に努めます。
            </div>

            <div class="">
                <span class="font-point_blk">1．個人情報の利用目的</span><br>
            ...
            <div class="">
                <span class="font-point_blk">2．個人情報の共同利用</span><br>
            ...
            <div class="">
                <span class="font-point_blk">6．苦情・お問い合わせ/span><br>
            ...
            <div class="">
                <span class="font-point_bblk">オンライン・プライバシーポリシー</span>
            </div>

            <div class="">
                <span class="font-point_blk">1.基本的考え方</span><br>
            ...
            <div class="">
                <span class="font-point_blk">2.収集する情報の範囲</span><br>
                「お問い合わせ」のご利用にあたっては、ご氏名、会社名、住所、電話番号、メールアドレス等について 任意に送信を願いしております。
            </div>

            <div class="">
                <span class="font-point_blk">3.利用目的</span><br>
                上記「個人情報の取り組み」の「2.個人情報の利用目的」に準じます。
            </div>

            <div class="">
                <span class="font-point_blk">4.利用及び提供の制限</span><br>
                上記「個人情報の取り組み」の「3.個人情報の共同利用」および「4.第三者提供」に準じます。
            </div>

            <div class="">
                <span class="font-point_blk">5.安全確保の措置</span><br>
                上記「個人情報の取り組み」の「5.個人情報の管理について」に準じます。
            </div>

            <div class="">
                <span class="font-point_blk">6.ログ情報、Cookie</span><br>
            ...
            <div class="">
                <span class="font-point_blk">Google社のプライバシーポリシーについて</span><br>
                Google Analyticsで収集したアクセスログに関するプライバシーポリシーについては、下記をご確認ください。（外部サイト）<br>
                <a href="https://policies.google.com/technologies/partner-sites">ユーザーがGoogleパートナーのサイトやアプリを使用する際のGoogleによるデータ使用</a><br>
                <a href="http://www.google.com/intl/ja/policies/privacy/">Google社のプライバシーポリシー</a>
            </div>

            <div class="">
                <span class="font-point_blk">7.適用範囲</span><br>
