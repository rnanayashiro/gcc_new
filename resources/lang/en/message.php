...
return [
    ...
    'representative_director' => 'President & CEO',
    'rep_name' => 'Nobuyuki Sano',
    'chairman_board' => 'Chairman of the Board',
    'chairman' => 'Koji Shimokawa',
    'director' => 'Director',
    'director_1' => 'Hajime Goto',
    'director_2' => 'Hikaru Nomura',
    'director_3' => 'Takashi Konno',
    ...
    // 人事コンサルティング
    'hr_consulting_intro' => 'Our team of experts including certified public accountants, tax accountants, and social insurance labor consultants provide cross-disciplinary consulting services related to human resources, organizations, and personnel.',
    'compensation_evaluation_consulting_title' => 'Consulting on Compensation and Evaluation Systems',
    'compensation_evaluation_consulting_text' => 'Business management and HR systems work effectively when linked together. Human resource strategies should exist within business and corporate strategies, and these should be concretely implemented in personnel systems. Even with an efficient organization and clear responsibilities and authority, if the content of work is not aligned with personnel evaluations and compensation, efficient management cannot be achieved. Generally, "personnel systems" consist of four pillars: evaluation systems, compensation (salary and bonuses) systems, recruitment systems, and education systems. Our group, led by social insurance labor consultants and certified public accountants, supports the construction of personnel evaluation and compensation systems tailored to your company\'s actual situation as engines for growth.',
    'labor_relations_audit_title' => 'Labor Relations Audits',
    ...
    'disclaimer_description' => "Global Corporate Consulting Co., Ltd. (hereinafter referred to as \"the Company\") takes utmost care when publishing information on this website.\n\nHowever, the Company does not guarantee the accuracy, usefulness, appropriateness, or safety of the content of this information for the user's purposes.\n\nAdditionally, the Company shall not be held liable for any damages incurred by users as a result of using or being unable to use this information or as a result of using this website.\n\nShould users refer to the information on this website and make any decisions, we strongly recommend consulting with reliable professionals before taking any action.\n\nThe Company shall not be responsible for any accidents, software or hardware issues, contamination by computer viruses, or loss or corruption of data resulting from the use of this website.\n\nThe Company reserves the right to change the information on this website without prior notice, and may suspend or discontinue its operation. We ask for your understanding in advance. The Company shall not be liable for any damages resulting from such changes, suspensions, or discontinuations of website operations, regardless of the reason. However, this exclusion does not apply if laws require otherwise.",

    'privacy_policy_title' => 'Handling of Personal Information',
    'privacy_policy_description' => "We may collect personal information (such as name, address, and email address) from users on this website.\n\nSuch personal information will only be used for purposes notified to users in advance. If used for other purposes, users will be informed of the new purpose beforehand.\n\nThe Company ensures that personal information will be securely managed and stored under reasonable management systems to prevent access by third parties.\n\nPersonal information will not be disclosed to third parties without the user's consent, except in the following cases (excluding information in statistical form that cannot identify individuals):\n(1) Disclosure is necessary to business partners to achieve the notified purpose (in such cases, business partners are required to strictly manage the information and use it solely for the intended purpose).\n(2) Disclosure is legally required by judicial or administrative institutions.\n\nIf you wish to inquire about, correct, or delete your provided personal information, we will respond promptly.",

    'links_policy_title' => 'Linking Policy',
    'links_policy_description' => "When linking to this website, please contact us in advance with details such as the operator of the linking website, the purpose of the link, and the URL of the linking page.\n\nLinks should point to the homepage of this website, and displaying the link within a frame as if it were part of your site is not allowed. In some cases, we may decline requests for linking.\n\nThe contents of third-party websites (\"link sites\") linked to or from this website are managed under the responsibility of their respective operators and are not under our control. Use of link sites is subject to the terms and conditions of the respective sites.\n\nThe Company does not endorse the use of link sites or the products, services, or companies featured on them, nor does it imply a special relationship, such as a partnership, with the operators of link sites. The Company shall not be responsible for any damages arising from the use of link sites.",
